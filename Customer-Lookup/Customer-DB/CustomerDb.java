...
public class CustomerDb {
    ...
    static Map<Name, ArrayList<Customer>> cusNameHashMap;
    ...
    public static Map<Name, ArrayList<Customer>> getNameMap(){
    	return cusNameHashMap;
    }
    ...
    public static void initialize() {
         ...
         ArrayList<Customer> nameList;
         cusNameHashMap = new HashMap<Name, ArrayList<Customer>>();
         
         phone = new PhoneNum(437, "225-6590");
         name = new Name("Jackson", "Sean");
         cus = new Customer(name, phone);
         cusList.add(cus);
         nameList = new ArrayList<Customer>();
         nameList.add(cus);
         cusNameHashMap.put(name, nameList);
